...
// These primitives are shared with lib/epub/embed-core.ts, which rebuilds OPFs
// from user-supplied EPUBs and needs the same linear guarantees.

// Character codes used by the few direct charCodeAt comparisons left below.
const CHAR_GT = 0x3e; // ">"
